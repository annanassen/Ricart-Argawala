...
type Req struct {
	...
	Juice         string                 `protobuf:"bytes,1,opt,name=juice,proto3" json:"juice,omitempty"`
...
const file_proto_proto_rawDesc = "" +
	...
	"\vproto.proto\"U\n" +
	"\x03req\x12\x14\n" +
	"\x05juice\x18\x01 \x01(\tR\x05juice\x12\x1a\n" +
	"\bsiteName\x18\x02 \x01(\tR\bsiteName\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\x03R\ttimestamp\"\a\n" +
	"\x05reply20\n" +
	"\rmessageServer\x12\x1f\n" +
	"\vsendMessage\x12\x04.req\x1a\x06.reply\"\x000\x01B\x10Z\x0eITU/grpc/protob\x06proto3"
